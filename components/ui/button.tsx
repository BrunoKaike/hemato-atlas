  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        normal:
        "bg-white normal-case text-black border-slate-200 text-slate-500",
        // custom
        locked:
        ...
        dangerLine:
          "bg-transparent text-rose-500 hover:bg-slate-100 border-rose-600 border-2 active:border-b-0",
        ...
        sidebarOutline:
          "bg-slate-500/15 text-slate-950 border-slate-950 border-2 hover:bg-slate-500/20 transition-none",
      },
      size: {
